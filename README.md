...
여행 중 찍은 영수증 사진을 AI가 자동으로 인식해 지출을 기록하고, 여행이 끝나면 그룹 정산을 자동으로 계산해주는 서비스의 백엔드. 프론트엔드는 별도 저장소 [`Snaptle/snaptle-frontend`](https://github.com/Snaptle/snaptle-frontend)에서 관리한다.
